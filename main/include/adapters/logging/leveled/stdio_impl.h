#ifndef ADAPTERS_LOGGING_LEVELED_STDIO_IMPL_H
#define ADAPTERS_LOGGING_LEVELED_STDIO_IMPL_H
...
} adp_logging_leveled_stdio_impl_cfg_t;

typedef struct {
    adp_logging_leveled_stdio_impl_cfg_t cfg;
} adp_logging_leveled_stdio_impl_ctx_t;
...
#endif /* ADAPTERS_LOGGING_LEVELED_STDIO_IMPL_H */